...
function loadMainScript()
    ...
    AimbotSection:AddToggle("Draw FOV", true, function(value)
        Aimbot:SetDrawFOV(value)
    end)
    AimbotSection:AddToggle("FOV Filled", false, function(value)
        Aimbot.Settings.FOVFilled = value
    end)
    AimbotSection:AddSlider("FOV Thickness", 1, 10, 2, function(value)
        Aimbot.Settings.FOVThickness = value
    end)
    AimbotSection:AddSlider("FOV Transparency", 0, 1, 1, function(value)
        Aimbot.Settings.FOVTransparency = value
    end)
    AimbotSection:AddColorPicker("FOV Color", Color3.fromRGB(255, 255, 255), function(value)
        Aimbot.Settings.FOVColor = value
    end)
    ...
    CrosshairSection:AddDropdown("Style", {"Cross", "Circle", "Square"}, "Cross", function(value)
        Crosshair.Settings.Style = value
        Crosshair:Create()
    end)
    CrosshairSection:AddSlider("Size", 5, 100, 15, function(value)
        Crosshair:SetSize(value)
    end)
    CrosshairSection:AddSlider("Thickness", 1, 10, 2, function(value)
        Crosshair:SetThickness(value)
    end)
    CrosshairSection:AddSlider("Gap", 0, 20, 5, function(value)
        Crosshair.Settings.Gap = value
        Crosshair:Create()
    end)
    ...
    CrosshairSection:AddSlider("Dot Size", 1, 10, 2, function(value)
        Crosshair.Settings.DotSize = value
        Crosshair:Create()
    end)
    CrosshairSection:AddToggle("Outline", true, function(value)
        Crosshair.Settings.Outline = value
        Crosshair:Create()
    end)
    CrosshairSection:AddSlider("Outline Thickness", 1, 5, 2, function(value)
        Crosshair.Settings.OutlineThickness = value
        Crosshair:Create()
    end)
    CrosshairSection:AddToggle("Filled", false, function(value)
        Crosshair.Settings.Filled = value
        Crosshair:Create()
    end)
    CrosshairSection:AddSlider("Transparency", 0, 1, 1, function(value)
        Crosshair.Settings.Transparency = value
        Crosshair:Create()
    end)
    CrosshairSection:AddColorPicker("Color", Color3.fromRGB(0, 255, 0), function(value)
        Crosshair:SetColor(value)
    end)
    CrosshairSection:AddColorPicker("Dot Color", Color3.fromRGB(0, 255, 0), function(value)
        Crosshair.Settings.DotColor = value
        Crosshair:Create()
    end)
    CrosshairSection:AddColorPicker("Outline Color", Color3.fromRGB(0, 0, 0), function(value)
        Crosshair.Settings.OutlineColor = value
        Crosshair:Create()
    end)
